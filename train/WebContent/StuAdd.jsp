...
<form onsubmit="return check()" action="./StuAddServlet" method="post">
    ...
    <tr>
        ...
        <td><input type="text" id="No" name="No" placeholder="请输入10位的学号" maxlength="10" required="required"><span></span></td>       
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" id="Sex" name="Sex" placeholder="男/女" required="required" maxlength="1"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="tel" id="Tel" name="Tel" placeholder="请输入11位的电话号码" maxlength="11" required="required"><span></span></td>
    </tr>
    <tr>
        <td></td>
        <td>
